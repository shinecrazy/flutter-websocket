...
class MockWebSocketListener extends _i1.Mock implements _i2.WebSocketListener {
  ...
  @override
  void onStringMessage(String? message) => super.noSuchMethod(
        Invocation.method(
          #onStringMessage,
          [message],
        ),
  ...
  @override
  void onByteArrayMessage(_i4.Uint8List? message) => super.noSuchMethod(
        Invocation.method(
          #onByteArrayMessage,
          [message],
        ),
  ...
  @override
  void onError(Exception? exception) => super.noSuchMethod(
        Invocation.method(
          #onError,
          [exception],
        ),
